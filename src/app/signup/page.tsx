  ...
  return (
    <main className="flex min-h-screen w-full flex-col  bg-[#211D19]">
      ...
      <section className="flex flex-col items-center justify-center">
        <div className="mt-[39px] flex min-h-[1089px] min-w-[500px] max-w-[880px] flex-col items-center rounded-[24px] bg-[#35322F] text-[#EDF1F3] md:w-[80%] lg:w-full">
          ...
          <div className="mt-[70px] flex w-full flex-col gap-[25px] px-[100px]">
            ...
            <p className="mb-[30px] text-center text-[14px] font-light">
