...
import styles from "./update-payment-method.module.css";

const UpdatePaymentMethod: NextPage = () => {
  return (
    <div className={styles.updatePaymentMethod}>
      <div className={styles.modal}>
        <div className={styles.content}>
          <PaymentCardContainer propWidth="unset" propAlignSelf="stretch" />
          <div className={styles.modalActions}>
            <div className={styles.button}>
              <div className={styles.buttonBase}>
                <div className={styles.text}>Remove Payment Method</div>
              </div>
            </div>
          </div>
        </div>
