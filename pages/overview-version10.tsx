...
import styles from "./overview-version10.module.css";

const OverviewVersion10: NextPage = () => {
  return (
    <div className={styles.overviewVersion10}>
      ...
      <div className={styles.coupon}>
        ...
        <div className={styles.parent}>
          <div className={styles.div1}>$ 1.25</div>
          <div className={styles.ktu7y9l}>KtU7y9L</div>
          <div className={styles.redeemCode}>Redeem Code</div>
        </div>
...
export default OverviewVersion10;
